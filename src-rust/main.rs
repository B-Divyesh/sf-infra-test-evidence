...
{"type":"test_summary","test_summary":{"status":"pass"}}"#;
    ...
    fn review_page_is_keyboard_scrollable() {
        ...
        assert!(html.contains("<h2>Input details</h2>"));
        assert!(!html.contains("<h2>Provenance</h2>"));
